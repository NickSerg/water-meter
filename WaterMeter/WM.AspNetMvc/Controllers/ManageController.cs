...
namespace WM.AspNetMvc.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> VerifyPhoneNumber(string phoneNumber)
        {
            ...
            var verifyPhoneNumberViewModel = new VerifyPhoneNumberViewModel { PhoneNumber = phoneNumber };
            return phoneNumber == null ? View("Error") : View(verifyPhoneNumberViewModel);
        }
